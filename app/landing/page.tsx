...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Архетипы — это модели коммуникации с аудиторией, основанные на психологических паттернах восприятия. В нашей системе 26 авторских архетипов: Мем, Трендовый, Эстетический, Кринжовый, WOW, Кислотный, Премиум, Ностальгический и другие. Каждый задаёт свой тон, визуал и эмоциональный крючок — AI подбирает тот, который лучше всего сработает для вашей аудитории.',
  },
  {
  ...
  {
    q: 'Можно ли загрузить свой логотип или фото продукта?',
    a: 'Да. На этапе заполнения брифа вы можете загрузить до 3 изображений — логотип, фото продукта, фото спикера или что угодно. AI встроит их прямо в баннер. Поддерживаются форматы JPG, PNG и WEBP.',
  },
  {
